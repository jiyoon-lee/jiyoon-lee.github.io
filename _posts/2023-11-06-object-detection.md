...
6. working directory 를 darknet으로 변경
7. 받은 darknet은 python코드가 아니라 c코드이므로 우리 시스템에 맞게 컴파일이 필요합니다.<br>
...
9. 이미지 1장을 이용해서 직접 Object Detection을 수행합시다.
