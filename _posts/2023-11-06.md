...
6. detection의 대상이 되는 클래스를 명시<br>
...
10. pretrained-model의 weights 다운로드
    ```python
    cd "$ROOT_FOLDER"
    ```
    ```python
...
16. `darknet/data`폴더에 `my_voc.data` 파일을 만듭니다.
